...
let currentMeal = null; // Variable to store the current meal details
...
favoriteBtn.addEventListener('click', () => {
    if (currentMeal) {
        ...
        const isFavorite = favoriteMeals.some(favMeal => favMeal.idMeal === mealId);
...
function displayMealDetails(meal) {
    ...
    mealVideo.innerHTML = `<iframe src="${meal.strYoutube.replace('watch?v=', 'embed/')}" frameborder="0" allowfullscreen></iframe>`;
